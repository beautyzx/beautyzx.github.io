...
export function addRomanceScene(compKey,context,callback){
  ...
  if(compKey==='yuer'){
    if(context==='chapter2'){
      addStory('山道旁，有一處清澈的山泉。你和沈夜涼取水休息，裴霜華先行一步。','narr');
      addStoryHTML('月光如練，灑在水面上。沈夜涼坐在石頭上，輕輕哼著一首不知名的小曲，神情恬靜。','romance');
      addStory('你問她為什麼叫「沈夜涼」。她笑著說：「娘說我出生的那晚，月亮特別圓，所以叫沈夜涼——就是說，人如月般，明亮溫柔。」','dialogue');
      ...
      addStory('進入古跡之前，你和沈夜涼站在山崖邊，俯瞰夜霧中的蜀山。','narr');
      ...
      showNotif('沈夜涼 緣份+15 · 「我信你」');
    }
  }else{
    if(context==='chapter2'){
      addStory('紮營休息時，你找到一個人獨坐的裴霜華。她在磨劍，動作緩慢而專注。','narr');
